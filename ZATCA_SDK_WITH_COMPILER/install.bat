...
REM Save SDK variables for the current user (local machine).
setx SDK_CONFIG "%MY_PATH%Configuration\config.json"
setx FATOORA_HOME "%MY_PATH%Apps\"

REM Avoid SETX PATH here to prevent truncation of long PATH values.
REM Use Apps\fatoora.bat directly, or add Apps\ to PATH manually if needed.

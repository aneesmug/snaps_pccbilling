...
//global $ui, $_L, $config, $routes, $file_build, $request, $plugin, $dd;
...
class Invoice extends Model
{
    ...
    public static function migrateTableUsingPdo()
    {
        ...
        if (self::tableExists($pdo, 'sys_invoices')) {
            self::ensureColumn(
                $pdo,
                'sys_invoices',
                'zatca_uuid',
                "VARCHAR(64) NULL AFTER `vtoken`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_invoice_type',
                "VARCHAR(20) NULL AFTER `zatca_uuid`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_status',
                "VARCHAR(30) NULL AFTER `zatca_invoice_type`"
            );
            ...
            self::ensureColumn(
                ...
                "VARCHAR(20) NULL AFTER `zatca_status`"
            );

            self::ensureColumn(
                $pdo,
                'sys_invoices',
                'zatca_submission_date',
                "DATETIME NULL AFTER `zatca_submission_status`"
            );
            ...
            self::ensureColumn(
                ...
                "MEDIUMTEXT NULL AFTER `zatca_submission_date`"
            );
            ...
            self::ensureColumn(
                ...
                "INT(11) NULL AFTER `zatca_submission_response`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_invoice_xml',
                "MEDIUMTEXT NULL AFTER `zatca_submission_http_code`"
            );

            self::ensureColumn(
                $pdo,
                'sys_invoices',
                'zatca_invoice_encoded',
                "LONGTEXT NULL AFTER `zatca_invoice_xml`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_invoice_hash',
                "TEXT NULL AFTER `zatca_invoice_encoded`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_signature',
                "LONGTEXT NULL AFTER `zatca_invoice_hash`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_public_key',
                "LONGTEXT NULL AFTER `zatca_signature`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_qr_signature',
                "LONGTEXT NULL AFTER `zatca_public_key`"
            );
            ...
            self::ensureColumn(
                ...
                "DATETIME NULL AFTER `zatca_qr_signature`"
            );
            ...
            self::ensureColumn(
                ...
                'sys_invoices',
                'zatca_last_response',
                "MEDIUMTEXT NULL AFTER `zatca_last_submit_at`"
            );
        }

        if (!self::tableExists($pdo, 'sys_zatca_logs')) {
            $pdo->exec('CREATE TABLE `sys_zatca_logs` (
    ...
    public static function pdf($id, $r_type = '', $token = '')
    {
        ...
        if ($d) {
            ...
            try {
                ...
                $watermark_text = $is_refunded_credit_note ? __('Refunded') : ($is_cancelled_invoice_pdf ? __('Cancelled') : __($d['status']));
                ...
                $creating_pdf = true;
                $pdf_tpl = APP_SYSTEM_PATH . '/lib/invoices/pdf-x2.php';
                ...
                if ($zatca_enabled && class_exists('Zatca')) {
                    ...
                    $qr_code = $zatca_qr_payload !== ''
                        ? (new QRCode())->render($zatca_qr_payload)
                        : '';
                } else {

    ...
    case 'view':
        ...
        if ($d) {
            ...
            if ($_buyer_type === 'individual') {
                $invoice_type_label = 'Simplified Tax Invoice';
            } elseif ($_buyer_type === 'company') {
                $invoice_type_label = 'Standard Tax Invoice';
            } else {
                $invoice_type_label = isset($config['zatca_invoice_type']) && $config['zatca_invoice_type'] === 'standard'

...
if ($s_version != $max) {
    ...
    if ($next_key === 5) {
        ...
        addOption('zatca_enabled', '0');
        addOption('zatca_phase2_enabled', '0');
        addOption('zatca_environment', 'sandbox');
        addOption('zatca_seller_name', '');
        addOption('zatca_vat_number', '');
        addOption('zatca_seller_crn', '');
        addOption('zatca_building_no', '');
        addOption('zatca_street_name', '');
        addOption('zatca_district', '');
        addOption('zatca_city', '');
        addOption('zatca_postal_code', '');
        addOption('zatca_country_code', 'SA');
        addOption('zatca_otp', '');
        addOption('zatca_compliance_csid', '');
        addOption('zatca_compliance_secret', '');
        addOption('zatca_production_csid', '');
        addOption('zatca_production_secret', '');

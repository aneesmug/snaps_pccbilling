...
$is_accounting_action = in_array($action, $accounting_actions, true);
...
/**
 * ============================================================
 * ACCOUNTING SYSTEM - FRONTEND PAGES
 * ============================================================
 * Include the accounting frontend controller for GL, AR, AP,
 * bank reconciliation, and financial reports pages
 * ============================================================
 */
if ($is_accounting_action) {
    require_once APP_SYSTEM_PATH . '/controllers/accounting-frontend.php';
}

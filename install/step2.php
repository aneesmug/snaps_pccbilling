...
$all_passed = true;
?>
<?php echo SnapSProductionInstaller::header('System requirements'); ?>
<body>
        ...
        <div class="card-body">
            <div class="col-md-12">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        <td>
                            <h3>Minimum PHP version 8.2</h3>
                            <p>
                                We use the latest coding syntax of PHP, which requires a minimum version of PHP 8.2 Of course, you can use any higher version.
                            </p>
                        </td>
                        <td>
...
<?php echo SnapSProductionInstaller::footer(); ?>

<form class="form-horizontal" id="rform">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-4">
            <div class="mb-3 h6"><label for="building_number"><span class="h6">Building Number</span></label>
                <input type="text" id="building_number" name="building_number" class="form-control" value="{$d['building_number']}" inputmode="numeric" maxlength="10" placeholder="e.g. 1234">
            </div>
        </div>
        <div class="col-md-4">

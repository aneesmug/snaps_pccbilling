                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="form-horizontal" id="rform">
                                    ...
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="building_number">Building Number</label>

                                        <div class="col-lg-10"><input type="text" id="building_number" name="building_number" class="form-control" value="{$d['building_number']}" autocomplete="off" inputmode="numeric" maxlength="10" placeholder="e.g. 1234">

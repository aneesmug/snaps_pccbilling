...
{*                                    <i class="fal fa-edit width-1"></i>*}
                        ...
                        {if $config['invoicing'] eq '1'}
                            ...
                            <a href="javascript:void(0)" id="dues" class="dropdown-item clx-side-menu-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                                <div class="svg-icon svg-icon-primary">
                                    <i class="fal fa-file-invoice-dollar width-1"></i>
                                    {$_L['Due Amount']}
                                </div>
                            </a>

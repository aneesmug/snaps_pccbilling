  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h2 class="card-title"><i class="fal fa-arrow-up"></i> {$_L['Accounts Payable Dashboard']|default:'Accounts Payable'}</h2>
        <div class="ibox-tools">
          <a href="{$_url}accounts/ap-dashboard/aging" class="btn btn-primary">
      ...
      <div class="card-body">
        ...
        <div class="row acct-summary-row">
          <div class="col-md-4">
            <div class="acct-metric-card acct-metric-teal">
              <h2 class="acct-metric-value">{$summary->total_vendors|default:0}</h2>
              <div class="acct-metric-label"><i class="fal fa-building"></i> {$_L['Total Vendors']|default:'Total Vendors'}</div>
          ...
          <div class="col-md-4">
            <div class="acct-metric-card acct-metric-red">
              <h2 class="acct-metric-value">{($summary->net_ap_outstanding|default:0)|number_format:2}</h2>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered datatable">
            <thead>
              <tr>
                <th>{$_L['Vendor']|default:'Vendor'}</th>
            ...
            {foreach $aging|default:[] as $id => $b}
              <tr>
                <td>{$b.vendor_name|default:'Unknown'}</td>

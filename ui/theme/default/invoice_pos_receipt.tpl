...
<div class="actions">
    <a class="btn-link" href="{$_url}invoices/pos-pdf/{$d['id']}/token_{$d['vtoken']}/view/">{$_L['View PDF']}</a>
    <a class="btn-link" href="{$_url}invoices/pos-print/{$d['id']}/token_{$d['vtoken']}" target="_blank">{$_L['Printable Version']}</a>
</div>

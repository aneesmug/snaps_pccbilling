...
{block name="head_extras_from_layout"}
    ...
    <style>
        /* Active child menu item highlight */
        #clx-navigation-menu ul > li.active > a,
        #clx-navigation-menu ul > li.active > a:hover {
            color: #fff !important;
            font-weight: 600 !important;
            background-color: rgba(255,255,255,0.12) !important;
            border-radius: 4px;
        }
        #clx-navigation-menu ul > li.active > a .nav-link-text {
            color: #fff !important;
        }
    </style>
    ...
    <aside class="page-sidebar">
        ...
        {else}
            ...
            <div class="page-logo">
                <a href="{$_url}dashboard" class="page-logo-link d-flex align-items-center position-relative">
                    ...
                    <span class="page-logo-text {if $config['nstyle'] == 'light_mode'} text-dark {else} text-white {/if} fw-bolder mr-1">
        ...
        <nav id="clx-primary-navigation" class="primary-nav" role="navigation">
            ...
            <ul id="clx-navigation-menu" class="nav-menu">
                    ...
                    <li class="{if $selected_navigation eq 'contacts'}active  open{/if}">
                        ...
                        <ul>
                            ...
                            {if !empty($config['google_maps_api_key'])}
                                <li>
                                    <a href="{$_url}contacts/map-view">
                                        <span class="nav-link-text">{__('Map View')}</span>
                                    </a>
                                </li>
                            {/if}
                    ...
                    {if $config['accounting'] eq '1'}
                        ...
                        <li class="{if $selected_navigation eq 'transactions'}active  open{/if}">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{$_url}accounts/dashboard">
                                        <span class="nav-link-text">Accounting Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/gl-accounts/list">
                                        <span class="nav-link-text">Chart of Accounts</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/journal-entries/list">
                                        <span class="nav-link-text">Journal Entries</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/ar-dashboard/dashboard">
                                        <span class="nav-link-text">AR Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/ap-dashboard/dashboard">
                                        <span class="nav-link-text">AP Dashboard</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/bank-reconciliation/list">
                                        <span class="nav-link-text">Bank Reconciliation</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/financial-reports/list">
                                        <span class="nav-link-text">Financial Reports</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/tax-vat/list">
                                        <span class="nav-link-text">Tax &amp; VAT</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{$_url}accounts/accounting-settings/periods">
                                        <span class="nav-link-text">Accounting Settings</span>
                                    </a>
                                </li>
                ...
                <li class="{if $selected_navigation eq 'agents'}active  open{/if}">
                    <a href="#">
                    ...
                    <ul>
                        <li>
                            <a href="{$_url}ai/agents/marketing-strategy-builder">
                                <span class="nav-link-text">{__('Marketing Strategy Builder')}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                {if has_access($user->roleid,'cms') && (!empty($config['cms'])) && $config['cms']}
                    ...
                    {if ($config['hrm'] eq '1')}
                        ...
                        <li class="{if $selected_navigation eq 'hrm'}active open{/if}">
                            ...
                            <ul>
                                ...
                                <li><a href="{$_url}hrm/timesheet"><span class="nav-link-text">{__('Timesheet')}</span></a></li>
                                ...
                                {foreach $sub_menu_admin['hrm'] as $sub_menu_hrm}
...
{*                            <span class="nav-link-text">{__('RAG')}</span></a></li>*}
{*                {/if}*}
                ...
                {if has_access($user->roleid,'reports')}
                    ...
                    <li class="{if $selected_navigation eq 'reports'}active open{/if}">
                        ...
                        <ul>
                            ...
                            <li><a href="{$_url}reports/zatca-submit-report"><span class="nav-link-text">ZATCA Submit Report</span></a></li>
                            <li><a href="{$_url}reports/zatca-returns-report"><span class="nav-link-text">ZATCA Returns Report</span></a></li>

                            {if has_access($user->roleid,'accounting_reports')}
                                <li class="nav-header" style="padding:6px 15px;font-size:10px;font-weight:700;text-transform:uppercase;color:#888;letter-spacing:.5px;">Accounting Reports</li>
                                <li><a href="{$_url}accounts/financial-reports/list"><span class="nav-link-text">Financial Reports</span></a></li>
                                <li><a href="{$_url}accounts/financial-reports/trial-balance"><span class="nav-link-text">Trial Balance</span></a></li>
                                <li><a href="{$_url}accounts/financial-reports/profit-loss"><span class="nav-link-text">Profit &amp; Loss</span></a></li>
                                <li><a href="{$_url}accounts/financial-reports/balance-sheet"><span class="nav-link-text">Balance Sheet</span></a></li>
                                <li><a href="{$_url}accounts/financial-reports/cash-flow"><span class="nav-link-text">Cash Flow Statement</span></a></li>
                                <li><a href="{$_url}accounts/ar-dashboard/aging"><span class="nav-link-text">AR Aging Report</span></a></li>
                                <li><a href="{$_url}accounts/ap-dashboard/aging"><span class="nav-link-text">AP Aging Report</span></a></li>
                                <li><a href="{$_url}accounts/tax-vat/vat-report"><span class="nav-link-text">VAT / Tax Report</span></a></li>
                                <li><a href="{$_url}accounts/tax-vat/zatca-status"><span class="nav-link-text">ZATCA Status</span></a></li>
                            {/if}
                ...
                {if has_access($user->roleid,'utilities')}
                    ...
                    <li class="{if $selected_navigation eq 'util'}active open{/if}">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="{$_url}ai/responses"><span class="nav-link-text">{__('AI Responses')}</span></a></li>
                ...
                {if has_access($user->roleid,'settings')}
                    <li class="{if $selected_navigation eq 'settings'}active open{/if}" id="li_settings">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="{$_url}settings/zatca"><span class="nav-link-text">ZATCA Config</span></a></li>
    ...
    <div class="page-content-wrapper">
        <header class="page-header" role="banner">
            ...
            <div class="hidden-md-down dropdown-icon-menu position-relative">
                ...
                <ul>
                    <li>
                        <a href="#" class="btn js-waves-off border-0" data-action="toggle" data-class="nav-function-minify" title="Minify Navigation">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M10.7071009,15.7071068 C10.3165766,16.0976311 9.68341162,16.0976311 9.29288733,15.7071068 C8.90236304,15.3165825 8.90236304,14.6834175 9.29288733,14.2928932 L15.2928873,8.29289322 C15.6714663,7.91431428 16.2810527,7.90106866 16.6757187,8.26284586 L22.6757187,13.7628459 C23.0828377,14.1360383 23.1103407,14.7686056 22.7371482,15.1757246 C22.3639558,15.5828436 21.7313885,15.6103465 21.3242695,15.2371541 L16.0300699,10.3841378 L10.7071009,15.7071068 Z" fill="#000000" fill-rule="nonzero" opacity="0.3" transform="translate(15.999997, 11.999999) scale(-1, 1) rotate(-270.000000) translate(-15.999997, -11.999999) "/>
                    ...
                    <li>
                        <a href="#" class="btn js-waves-off border-0" data-action="toggle" data-class="clx-fixed-navigation" title="Lock Navigation">
                                <span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <mask fill="white">
            ...
            <div class="ms-auto d-flex">
                ...
                <div>
                    ...
                    <a href="javasctipt:;" id="get_activity" class="header-icon cursor-pointer" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><svg width="24px" height="24px" viewBox="0 0 24 24"><defs/>
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z" fill="#000000" opacity="0.3"/>
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-xl p-0">
                        <div class="dropdown-header d-flex justify-content-center align-items-center rounded-top mb-2">
                            <a href="{$base_url}settings/quick-links">
                        ...
                        <div class="custom-scroll h-100">
                            ...
                            {if !empty($user.preferences.quick_links)}
                                {assign var="decoded_quick_links" value=$user.preferences.quick_links|json_decode:true}

                                {if !empty($decoded_quick_links)}
                                    {foreach $decoded_quick_links as $quick_link}
                                        <a href="{$quick_link.url}"
                                           {if $quick_link.open_new_tab}
                                               target="_blank"
                                           {/if}
                                           class="dropdown-item">
                                            {$quick_link.name}
                            ...
                            <a href="{$base_url}settings/quick-links" class="dropdown-item">
                                {$_L['Manage']}
                            </a>
                        </div>
                    </div>
...
{*            {/if}*}
    ...
    <script>
    // Highlight active child menu item using server-provided route (works with both pretty URLs and ?ng= mode)
    (function () {
        var clxCurrentRoute = '{$current_route|escape:'javascript'}';
        if (!clxCurrentRoute) return;

        function clxMarkActiveChild() {
            var navMenu = document.getElementById('clx-navigation-menu');
            if (!navMenu) return;

            var bestLink = null;
            var bestLen = 0;

            navMenu.querySelectorAll('ul > li > a[href]').forEach(function (a) {
                var href = a.getAttribute('href');
                if (!href || href === '#') return;
                // Extract the route portion from href (works for both /base/route and /?ng=route)
                var routePart = '';
                var ngIdx = href.indexOf('?ng=');
                if (ngIdx !== -1) {
                    routePart = href.substring(ngIdx + 4);
                } else {
                    // pretty URL: strip base URL prefix
                    var base = '{$_url|escape:'javascript'}';
                    if (href.indexOf(base) === 0) {
                        routePart = href.substring(base.length);
                    }
                }
                routePart = routePart.replace(/\/+$/, ''); // trim trailing slashes
                if (routePart.length > 0 && (clxCurrentRoute === routePart || clxCurrentRoute.indexOf(routePart + '/') === 0) && routePart.length > bestLen) {
                    bestLink = a;
                    bestLen = routePart.length;
                }
            });

            if (bestLink) {
                var li = bestLink.parentElement;
                if (li) {
        ...
        // Run after window load so nav plugins finish first, then re-apply
        window.addEventListener('load', function () {
            clxMarkActiveChild();
            // Re-apply after a short delay in case nav plugin runs late
            setTimeout(clxMarkActiveChild, 300);
        });
    })();
    ...
    (function () {
            ...
            window.addEventListener('DOMContentLoaded', () => {
                const btnTimer = document.getElementById('btnClxTimer');
                
                if(btnTimer)
            {
                const timer_count = document.getElementById('clx_timer_count');
                const timer = new easytimer.Timer();
                btnTimer.addEventListener('click', () => {
                    btnTimer.disabled = true;
                    window.location.href = '{$base_url}hrm/handle-timer';
                });
    ...
    (function () {
        ...
        function clxTriggerPreferredButton(candidates) {
        ...
        function clxFindWarehouseBlock() {
            var warehouseField = document.querySelector('#warehouse_id, [name="warehouse_id"], #warehouse, [name="warehouse"], select[aria-label*="Warehouse" i], input[aria-label*="Warehouse" i]');
            if (warehouseField) {
                return warehouseField.closest('.mb-3, .form-group, .col-md-6, .col-md-4, .col-sm-4, .col-sm-3');
            }

            var labels = document.querySelectorAll('label');
            for (var i = 0; i < labels.length; i++) {
                var txt = (labels[i].textContent || '').trim().toLowerCase();
                if (txt.indexOf('warehouse') !== -1) {
                    return labels[i].closest('.mb-3, .form-group, .col-md-6, .col-md-4, .col-sm-4, .col-sm-3');
                }
            }
            return null;
        }

        function clxFindStatusField() {
            return document.querySelector('#status, select[name="status"], input[name="status"]');
        }

        function clxSetDraftStatus() {
            var statusField = clxFindStatusField();
            if (!statusField) {
                var form = document.querySelector('#invform, form');
                if (form) {
            ...
            if (statusField.tagName === 'SELECT' || statusField.tagName === 'INPUT') {
                statusField.value = 'Draft';
                statusField.dispatchEvent(new Event('change', { bubbles: true }));
            }
        }

        function clxSetPublishedStatus() {
            var statusField = clxFindStatusField();
            if (!statusField) {
                return;
            }
        ...
        function clxInjectPosActions() {
            var block = clxFindWarehouseBlock();
            if (!block || block.querySelector('#clx_pos_save_btn')) {
                return !!block;
            }
            ...
            block.innerHTML = '' +
                ...
                '<button type="button" class="btn btn-outline-secondary btn-sm flex-fill" id="clx_pos_save_close_btn">Save Close</button>' +
                '<button type="button" class="btn btn-warning btn-sm flex-fill" id="clx_pos_save_draft_btn">Draft</button>' +
                '<button type="button" class="btn btn-primary btn-sm flex-fill" id="clx_pos_save_btn">Save</button>' +
                '</div>';

            var saveCloseBtn = document.getElementById('clx_pos_save_close_btn');
            var saveDraftBtn = document.getElementById('clx_pos_save_draft_btn');
            var saveBtn = document.getElementById('clx_pos_save_btn');

            if (saveCloseBtn) {
                saveCloseBtn.addEventListener('click', function () {
                    if (!clxTriggerPreferredButton(['#save_n_close', '#save_n_close_btn', 'button[name="save_n_close"]'])) {
                        clxSetPublishedStatus();
                        clxTriggerPreferredButton(['#submit', '#submit_btn', 'button[type="submit"]']);
                    }
                });
            }
        ...
        // Run immediately and keep observing dynamic UI updates.
        clxInjectPosActions();

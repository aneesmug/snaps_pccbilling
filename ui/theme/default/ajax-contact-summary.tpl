...
<div class="row">
    <div class="col-md-6 text-black">
        ...
        <div>
            ...
            <strong class="h5">Buyer Type: </strong>
            {if ($d['buyer_type']) eq 'company'}Company
            {elseif ($d['buyer_type']) eq 'individual'}Individual
            {else}N/A
            {/if}
            <br>
            ...
            {if ($d['buyer_type']) eq 'company'}
                <strong class="h5">Buyer VAT Number: </strong> {if ($d['tax_number']) neq ''}{$d['tax_number']}{else} N/A {/if} <br>
                <strong class="h5">Unified No. (700#): </strong> {if ($d['entity_number']) neq ''}{$d['entity_number']}{else} N/A {/if} <br>
            {elseif ($d['buyer_type']) eq 'individual'}
                <strong class="h5">ID/Iqama: </strong> {if ($d['entity_number']) neq ''}{$d['entity_number']}{else} N/A {/if} <br>
            {/if}
